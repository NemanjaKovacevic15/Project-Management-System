    ...
    <form:form method="POST" modelAttribute="task" class="form-horizontal">
        ...
        <form:input type="hidden" path="id" id="id"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='input-group date' id='deadLine'>
                            <form:input path="deadLine" class="form-control" readonly="true"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <form:select id="project" path="project" class="form-control input-sm" readonly="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <form:select id="developer" path="developer" class="form-control input-sm" readonly="true" >
                            <form:option value="" selected="selected">--select developer--</form:option>
